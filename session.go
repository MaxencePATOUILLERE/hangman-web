...
func haveAlreadyCookie(session *sessions.Session, w http.ResponseWriter) bool {
	if session.Values["uid"] != nil {
		fmt.Fprintf(w, "You have already a session delete cookies.")
		return true
	}
	return false
}
